    ...
    def __call__(
        ...
        **kwargs,
        ...
        clip_image_embeds = self.image_encoder(
            clip_image.to(device, dtype=torch.float16)
        ).image_embeds
        ...
        if initially_noise is None:
            ...
            initially_noise = latents
        else:
            latents = initially_noise + clc_gain*(out_latent_clc.clone()-initially_noise)
        ...
        # device,
        # generator,)
                # latents = initially_noise
        # else:
        #     latents = out_latent_clc
        # latents_first_sample = latents
        ...
        if not return_dict:
            return images
        # video_out = Pose2VideoPipelineOutput(videos=images)
        return images,latents,initially_noise
